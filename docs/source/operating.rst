[realtimeiotdataprocessing-with-ml-3f10] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [realtimeiotdataprocessing-with-ml-3f10] container is NOT running**.

.. tip::
   You must have your [realtimeiotdataprocessing-with-ml-3f10] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=41581  \-\-env VIPERVIZPORT=36389  \-\-env GITUSERNAME='smaurice101'  \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180'  \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:36389/iot-failure-machinelearning.html?topic=iot-preprocess,iot-ml-prediction-results-output&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:36389/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=60867
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=49427
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - maadsdocker/realtimeiotdataprocessing-with-ml-3f10-amd64
...
It can be accessed by entering: http://localhost:41579
...
.. important::
   http://localhost:60867/iot-failure-machinelearning.html?topic=iot-preprocess,iot-ml-prediction-results-output&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:60867/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:60867/<html file>
...
[realtimeiotdataprocessing-with-ml-3f10] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/smaurice101/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/realtimeiotdataprocessing-with-ml-3f10
...
.. important::
   solution_preprocessing_ml_dag-realtimeiotdataprocessing-with-ml-3f10
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=49427, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=45831, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=45311, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=35115, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=41457, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=46447, HPDEHOST=127.0.1.1, HPDEPORT=40865, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=46223

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-8675-realtimeiotdataprocessing-with-ml-3f10,solution_preprocessing_ml_dag-realtimeiotdataprocessing-with-ml-3f10, python-preprocess-3821-realtimeiotdataprocessing-with-ml-3f10,solution_preprocessing_ml_dag-realtimeiotdataprocessing-with-ml-3f10, python-ml-4769-realtimeiotdataprocessing-with-ml-3f10,solution_preprocessing_ml_dag-realtimeiotdataprocessing-with-ml-3f10, python-predict-1660-realtimeiotdataprocessing-with-ml-3f10,solution_preprocessing_ml_dag-realtimeiotdataprocessing-with-ml-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
